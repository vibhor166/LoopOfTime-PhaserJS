class Road extends Phaser.GameObjects.Container {
  ...
  addObject() {
    var objs = [
      { key: 'pcar1', speed: 20, scale: 10 },
      { key: 'pcar2', speed: 20, scale: 10 },
      { key: 'cone', speed: 20, scale: 15 },
      { key: 'barrier', speed: 20, scale: 8 },
      { key: '1', speed: 20, scale: 10 },
      { key: '2', speed: 20, scale: 10 },
      { key: '3', speed: 20, scale: 10 },
      { key: '4', speed: 20, scale: 10 }
    ];
